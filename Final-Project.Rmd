...
It looks like 50% of the cars are in the range of 18500 - 26995. However, there are many cars that are above this range.
...
It appears that most of our cars are from between 2014 - 2017. It is a little hard to tell how many cars there are by make in the graph above, so let's try to make that better.
...
The top 5 cars by count are Ford, Chevrolet, Toyota, Nissan, and Honda.
...
It looks like the most expensive type of car is a Ford. Nissan and Honda have similar price ranges, and I would say they have a slightly lower price than the other cars, especially for newer cars. 
...
It appears that most of the cars in the data have less than 100,000 miles on them. About half of the cars that have less than 100,000 miles are at the median price or lower. Looking at the cars that have over 100,000 miles, it is clear that a larger amount of cars are being sold at a price that we are considering as cheap. Based on this plot, there is evidence that supports the idea that having less mileage on a car will make the price value higher.